...
public class NinjaView {
    public static void display(Scanner scanner, DatabaseConnection dbConnection) {
        while (true) {
            ...
            System.out.println("                 Gestión de Ninjas");
            System.out.println(PURPLE+"╰─"+YELLOW+"..★."+PURPLE+"────────────────────────────────────────────────╯"+RESET);
            System.out.println("");
            ...
            switch (choice) {
                case 1:
                    NinjaController.registrarNinja(scanner, dbConnection.getConnection());
                    return;
                case 2:
                    verNinjas(dbConnection.getConnection());
                    break;
                case 3:
                    return;
                default:
    ...
    public static void verNinjas(Connection connection) {
        try {
        final String RESET = "\033[0m";
        final String RED = "\033[31m";
        final String GREEN = "\033[32m";
